...
__targets/tiger --filter=example.cpp\
...
__targets/tiger --objdir=__targets --filter=example.cpp\
	--init=red:lenna-r.png,green:lenna-g.png,blue:lenna-b.png \
	--dest=red:__targets/lenna-r.png,green:__targets/lenna-g.png,blue:__targets/lenna-b.png \
	--iterations=1

__targets/tiger --filter=grayscott.cpp --objdir=__targets --params=d:2,k:0.0610,F:0.0380\
