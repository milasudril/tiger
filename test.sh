...
gdb --args __targets/tiger-cli --filter=testdata/grayscott.cpp --params-list --channels-list --objdir=__targets \
	--params=d:2,k:0.0610,F:0.0380\
	--init=u:testdata/lenna-r.png,v:testdata/lenna-g.png --dest=u:__targets/gs-u.png,v:__targets/gs-v.png\
	--iterations=10000
